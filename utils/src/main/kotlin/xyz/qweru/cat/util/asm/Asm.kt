...
class ClassBuilder(val classNode: ClassNode) {
    ...
    fun method(
        ...
        parameters: List<CMethodParameter> = listOf(),
...
class InsnBuilder(val instructions: InsnList, val locals: MutableList<LocalVariableNode>, localOffset: Int) {
     ...
     */
    constructor(methodNode: MethodNode, parameters: List<CMethodParameter>, ownerDesc: String?) : this(
...
val ClassNode.isInterface: Boolean
    get() = access and Opcodes.ACC_INTERFACE == Opcodes.ACC_INTERFACE
